...
<strong> 2.	Data Cleansing</strong>
To prepare the data before processing it, we striped out all the white space, dealt with missing values, 
and calculated the exact number of exits and entries.
<strong>  3.	Descriptive Analysis & Data Visualization </strong> 
...
Lastly, we suggested the top five stations in May and August also the preferable hours during weekend and weekdays. So far, the project was so challenging, yet, I enjoyed every minute working on it, I have learned how to use Pandas and Seaborn and apply them in my project.
